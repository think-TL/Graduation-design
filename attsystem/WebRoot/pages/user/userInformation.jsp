					...
					<div class="admin-content-body">
						<div class="am-g">
							...
							<div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
								<form class="am-form am-form-horizontal" action="user/alertUser" method="get" >
									<input type="text" name="u_id" value="${user.u_id}" style="display:none"/>
									<div class="am-form-group">
										<label class="am-u-sm-3 am-form-label">姓名 / Name</label>
										<div class="am-u-sm-9">
											<input type="text" name="user-name" value="${user.u_name }" disabled>
										</div>
									</div>
									...
									<div class="am-form-group">
										...
										<div class="am-u-sm-9">
											<input type="text" name="userEmail" value="${user.u_email }">
										</div>
									</div>
									...
									<div class="am-form-group">
										...
										<div class="am-u-sm-9">
											<input type="text" name="userPhone" value="${user.u_phone }">
										</div>
									</div>
									...
									<div class="am-form-group">
										...
										<div class="am-u-sm-9">
											<input type="text" name="userQQ" value="${user.u_QQ}">
										</div>
									</div>
									...
									<div class="am-form-group">
										...
										<div class="am-u-sm-9">
											<input type="text" name="userAddress" value="${user.u_address}">
										</div>
									</div>
									<div class="am-form-group">
										<label class="am-u-sm-3 am-form-label">职位/job</label>
										<div class="am-u-sm-9">
											<input type="text" id="userJob" value="${user.u_job }" disabled>
										</div>
									</div>
									<div class="am-form-group">
										<label class="am-u-sm-3 am-form-label">部门 /department</label>
										<div class="am-u-sm-9">
											<input type="text" id="userDepart" value="${department.d_name}" disabled>
										</div>
									</div>
									<div class="am-form-group">
